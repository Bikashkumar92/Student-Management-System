...
class Student:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Student Management System",bd=10,relief=GROOVE,font=("times new roman",40,"bold"),bg="yellow",fg="black")
        ...
        Manage_Frame.place(x=10,y=100,width=350,height=540)
 ...
 #==========Detail Frame=========
        ...
        Detail_Frame.place(x=370,y=100,width=640,height=600)
...
#============= Table Frame=========
    ...
    def add_students(self):
        con=pymysql.connect(host="localhost",user="root",password="",database="stdm")
        cur=con.cursor()
